...
if (isset($_POST['search'])) {
    ...
    if ($category != "" && $subCategory != "") {
        $proRes = $dbProduct->getProductsByCatAndSubCat($category, $subCategory);
    } else if ($category == "" && $subCategory != "") {
        $proRes = $dbProduct->getProductBySubCategory($subCategory);
    } else if ($category != "" && $subCategory == "") {
        $proRes = $dbProduct->getProductByCategory($category);
    } else {
...
<div class="center-block" style="width: 500px;">
    ...
    <form action="" method="post">
        ...
        <br/>
        <div class="input-group">
            <button style="width: 500px" type="submit" name="search" class="btn btn-primary"><i class="glyphicon glyphicon-search"></i> Search</button>
        </div>
        <br/>
    </form>
